 ...
 */
final class Version20260423090055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__packs_services AS SELECT id, montant, date_mes, locataires_id_id FROM packs_services');
        $this->addSql('DROP TABLE packs_services');
        $this->addSql('CREATE TABLE packs_services (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, montant DOUBLE PRECISION DEFAULT NULL, date_mes DATE DEFAULT NULL, locataires_id_id INTEGER NOT NULL, CONSTRAINT FK_620DE8E1333BAD6 FOREIGN KEY (locataires_id_id) REFERENCES locataires (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO packs_services (id, montant, date_mes, locataires_id_id) SELECT id, montant, date_mes, locataires_id_id FROM __temp__packs_services');
        $this->addSql('DROP TABLE __temp__packs_services');
        $this->addSql('CREATE INDEX IDX_620DE8E1333BAD6 ON packs_services (locataires_id_id)');
        $this->addSql('ALTER TABLE paiements_mensuels ADD COLUMN regul_packs_services DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('ALTER TABLE paiements_mensuels ADD COLUMN regul_provisions_pour_charges DOUBLE PRECISION DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE packs_services ADD COLUMN montant_regularisation DOUBLE PRECISION DEFAULT NULL');
