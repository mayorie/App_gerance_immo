 ...
 */
final class Version20260423130537 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO locataires (id, nom, prenom, tel, mail, date_de_naissance, lieu_de_naissance, debut_bail, montant_caution, loyer_tcc, restant_du_trop_percu, date_edl_entree, preavis_recu_le, debut_du_preavis, date_edl_sortie, date_de_sortie, montant_solde_de_tout_compte, date_solde_de_tout_compte, mode_paiement_solde_de_tout_compte, banque_solde_de_tout_compte, cloture_contrat_visale, a_quitte_le_logement, logements_id_id) SELECT id, nom, prenom, tel, mail, date_de_naissance, lieu_de_naissance, debut_bail, montant_caution, loyer_tcc, restant_du_trop_percu, date_edl_entree, preavis_recu_le, debut_du_preavis, date_edl_sortie, date_de_sortie, montant_solde_de_tout_compte, date_solde_de_tout_compte, mode_paiement_solde_de_tout_compte, banque_solde_de_tout_compte, cloture_contrat_visale, a_quitte_le_logement, logements_id_id FROM __temp__locataires');
