...
class PackServicesSeedTest extends Fixture implements FixtureGroupInterface, DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $data = [
            [$BucheGatignol, 0.00, new \DateTime('2024-09-01')],
            [$BucheGatignol, 0.00, new \DateTime('2025-02-01')],
            [$Martin, 0.00, new \DateTime('2022-10-15')],
            [$Martin, 0.00, new \DateTime('2023-02-01')],
            [$Leroy, 0.00, new \DateTime('2025-01-10')],
            [$Leroy, 0.00, new \DateTime('2026-02-01')],
            [$Durand, 0.00, new \DateTime('2022-03-15')],
            [$Moreau, 0.00, new \DateTime('2023-06-01')],
            [$Garnier, 0.00, new \DateTime('2021-06-01')],
            [$Garnier, 0.00, new \DateTime('2022-02-01')],
            [$Garnier, 0.00, new \DateTime('2023-02-01')],
            [$Petit, 70.00, new \DateTime('2024-01-01')],
            [$Rousseau, 70.00, new \DateTime('2022-06-01')],
            [$Bernard, 70.00, new \DateTime('2021-01-15')],
            [$Legrand, 70.00, new \DateTime('2021-10-01')],
            [$Marchand, 70.00, new \DateTime('2022-10-10')],
            [$Garcias, 70.00, new \DateTime('2024-04-15')],
            [$Caron, 70.00, new \DateTime('2025-03-01')],
            [$hugos, 50.00, new \DateTime('2023-06-01')],
            [$Picard, 50.00, new \DateTime('2021-09-01')],
            [$Lambert, 50.00, new \DateTime('2022-05-01')],
        ];

        foreach ($data as [$locataire, $montant, $date]) {
            $PS = new PacksServices();
            $PS->setLocatairesID($locataire);
            $PS->setMontant($montant);
            $PS->setDateMES($date);
